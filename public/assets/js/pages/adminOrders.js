          ...
          <div class="card px-4 py-3 mb-2">
            ...
            <div class="collapse" id="collapse${i}">
              <div class="pt-4">
                ...
                <div class="d-flex align-items-center">
                  <span class="text-muted h4">Status do pedido: ${statusProduct}</span>
                </div>
                <div class="d-flex justify-content-end">
                  <span class="text-muted h4 align-items-md-end"><strong>Total do pedido: ${(totalProdutctEnd).toFixed(2)}</strong></span>
                </div>
                <div class="d-flex justify-content-end">
                  <button id="${e.id}" type="submit" class="btn btn-primary align-items-md-end confirmPayed">Confirmar pagamento</button>
                </div>
              </div>
            </div>
          </div>
