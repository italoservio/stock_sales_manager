...
class Helper
{
  ...
  public static function pageTitle($p_filename)
  {
    switch ($p_filename) {
      case 'index':
        return 'SSM: Página Inicial';
      case 'login':
        return 'SSM: Acesso';
      case 'signup':
        return 'SSM: Cadastro';
      case 'admin':
        return 'SSM Admin: Home';
      case 'adminOrders':
        return 'SSM Admin: Vendas';
      case 'adminUsers':
        return 'SSM Admin: Usuários';
      case 'adminProducts':
        return 'SSM Admin: Produtos';
      case 'adminCategories':
        return 'SSM Admin: Categorias';
      case 'adminStatistics':
        return 'SSM Admin: Estatísticas';
      case 'profile':
        return 'SSM: Perfil';
      case 'product':
        return 'SSM: Produto';
